      ...
      success:function(data){
        ...
        if(data.flag==1){
          ...
          for(i;i<len;i++){
            ...
            html.push('<div class="hemaiT">');
            html.push('<p>'+D[i].lotteryName+'</p>');
            if(D[i].schemeTop){html.push('<i></i>');}
            ...
            html.push('<strong>'+pro+'</strong>');

            html.push('</div>');
            html.push('<div class="hemaiC">');
            html.push('<div class="hemaiC1"><p>'+t+'</p><p>'+D[i].level+'</p></div>');
            html.push('<div class="hemaiC2"><p>'+D[i].schemeAmount+'元<br/><var>总金额</var></p><p>'+D[i].personCount+'人<br/><var>参与</var></p><p>'+D[i].remainAmount+'元<br/><var>剩余</var></p></div>');
            html.push('</div></a></li>');
          }
