		...
		$.ajax({
			...
			success:function(data){
				...
				if(data.bindingBank==1){
                    ...
                    html.push('<p class="userPartBox62">提款规则</p>');
                    html.push('<p class="userPartBox63">一 提款转账费：<br/>');
                    html.push('1、提款转账费2元/笔<br/>');
                    html.push('2、新注册并充值用户首次体验提款转账费由网站代付（异常提款除外）<br/>');
                    html.push('3、单次提款金额大于100元，每位用户每月享有3次的免费提款机会（转账费由网站代付，异常提款除外）</p>');
                    html.push('<p class="userPartBox63">二 审核时间：<br/>');
                    html.push('周一到周日  09：00-17：00（法定节假日除外）</p>');
                    html.push('<p class="userPartBox63">三 到账时间：<br/>');
                    html.push('招行最快10分钟内可到账，工行、农行、建行、在当天财务审核处理后一般2小时内到账，其他银行一般需要1-3个工作日</p>');
                    html.push('<p class="userPartBox63">四 风控规则：<br/>');
                    html.push('1、提款申请人的银行卡姓名与本站填写的真实姓名必须一致，否则款项无法汇出<br/>');
                    html.push('2、凡遇网站活动期间，用户充值本金及赠送彩金，只能用于购彩，不能提现<br/>');
                    html.push('3、为了防止利用信用卡套现和洗钱行为，银行针对异常提款做出如下规定：<br/>');
                    html.push('（1）单笔消费后不满30%的提款申请，将加收最高10%（最少10元起）的异常提款处理费用。<br/>（2）异常提款首次系统将自动驳回并短信通知用户原因，如再次申请将按异常提款（最高10%提款手续费）处理。<br/>（3）异常提款到账时间自申请之日起不得低于15个工作日。</p>');
				}else{
